...
internal static partial class Windows
{
    public partial class WindowsEventStream
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var console = Tutu.Windows.Windows.Console.CurrentIn;
        ...
        private static bool WaitEvent(Tutu.Windows.Windows.Handle handle, Duration? timeout)
        {
            ...
            {
                throw Tutu.Windows.Windows.GetExceptionForWin32Error(Marshal.GetLastPInvokeError());
            }
        ...
        private IEvent? Parse(INPUT_RECORD @event, ref ushort? surrogate)
        {
            ...
            {
                return @event.Event.bSetFocus ? Tutu.Events.Event.FocusGained : Tutu.Events.Event.FocusLost;
            }

            if (eventType == EventType.WindowBufferSizeEvent)
            {
                return Tutu.Events.Event.Resize(
