...
public static class StyledContentExtensions
{
    ...
    public static StyledContent<T> UnderlineGrey<T>(this T content) where T : notnull =>
        new StyledContent<T>(s_default, content).UnderlineGrey();
}
